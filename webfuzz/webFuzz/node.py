...
class Node:
    def __init__(self,
        ...
        self._cover_score_xor: int = 0
        self._cover_score_single: int = 0
    ...
    def parse_instrumentation(self,
        ...
        if instrument_args.output_method == OutputMethod.HTTP:
            ...
            instr_dir = os.environ.get("WEBFUZZ_INSTR_DIR", "/var/instr")
            iterator = parse_file(os.path.join(instr_dir, "map." + worker_id))
    ...
    def __getstate__(self) -> Dict[str, Any]:
        ...
        if hasattr(self, '_request_baseline_ordinal'):
            state['request_baseline_ordinal'] = self._request_baseline_ordinal
        if hasattr(self, '_request_sha256'):
            state['request_sha256'] = self._request_sha256
